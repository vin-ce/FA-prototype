  ...
  return (
    <div className={styles.container}>
      <div className={styles.scrollContainer}>
        ...
        <Image priority="true" src="/profile/Profile BG.png" alt="bg image" width={100} height={100} className={styles.bg} />
        <div className={styles.profileInfo}>
          <Image priority="true" src="/profile/Profile.png" alt="profile image" width={100} height={100} className={styles.profile} />
        ...
        <div className={styles.archive}>
          ...
          <div className={styles.images}>
            <div className={styles.imageModule}>
              <Image priority="true" src="/profile/Profile Archive 1.png" alt="profile image" width={100} height={100} />
              <div className={styles.date}>Jun 02 2023</div>
            </div>
            <div className={styles.imageModule}>
              <Image priority="true" src="/profile/Profile Archive 2.png" alt="profile image" width={100} height={100} />

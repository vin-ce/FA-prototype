...
import MentorProfile1 from "@/assets/icons/Mentor_Profile_1.png"
import MentorProfile2 from "@/assets/icons/Mentor_Profile_2.png"
        ...
        <div className={styles.contentContainer}>
          ...
          <div className={styles.mentorsContainer}>
            <div className={styles.mentor}>
              <Image src={MentorProfile1} width={80} height={80} alt={"mentor image"} />
              S. Wiley
            </div>
            <div className={styles.mentor}>
              <Image src={MentorProfile2} width={80} height={80} alt={"mentor image"} />
              M. Dean
            </div>
          </div>
